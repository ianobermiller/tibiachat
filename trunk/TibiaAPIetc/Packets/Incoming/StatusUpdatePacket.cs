...
namespace Tibia.Packets
{
    public class StatusUpdatePacket:Packet
    {
        ...
        public StatusUpdatePacket() : base()
        {
            type = PacketType.StatusUpdate;
            destination = PacketDestination.Client;
        }

        public StatusUpdatePacket( byte[] data,bool longcap)
            :this()
        {
        ...
        /// <returns></returns>
        public static StatusUpdatePacket Create( int hp, int maxHp, int cap, bool longcap, int exp, int level, byte xpbar, int mana, int maxMana, byte magicLvl, byte soul, int stamina)
        {
            ...
            p.AddByte(soul);
            p.AddInt(stamina);
            return new StatusUpdatePacket(p.GetPacket(),longcap);
        }
    }
}
