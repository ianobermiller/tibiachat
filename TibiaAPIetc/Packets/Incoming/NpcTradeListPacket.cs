...
namespace Tibia.Packets
{
    public class NpcTradeListPacket : Packet
    {
        ...
        public NpcTradeListPacket()
            : base()
        {
            type = PacketType.NpcTradeList;
            destination = PacketDestination.Client;
        }
        public NpcTradeListPacket( byte[] data)
            : this()
        {
            ParseData(data);
        }
        ...
        public static NpcTradeListPacket Create( List<TradeItem> items)
        {
            PacketBuilder p = new PacketBuilder(PacketType.NpcTradeList);
            ...
            return new NpcTradeListPacket(p.GetPacket());
        }
    }
